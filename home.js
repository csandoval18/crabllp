(function ($) {
	$(document).ready(function () {
		...
		console.log('slidewith:', slideWidth);
		...
		function dragEnd() {
			// three possibilities: 1. next slide 2. prev slide 3. stay still
	...
	// 	const topElementToTopViewPort = aboutRight.getBoundingClientRect().top;
	// 	if (
	// 		scrollTop >
	// 		(scrollTop + topElementToTopViewPort).toFixed() - clientHeight
	// 	) {
